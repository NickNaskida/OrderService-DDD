...
from src.features.allocation.service_layer import handlers, messagebus, unit_of_work
...
class TestAllocate:
    ...
    def test_sends_email_on_out_of_stock_error(self):
        ...
        with mock.patch("src.features.allocation.infrastructure.email.send") as mock_send_mail:
